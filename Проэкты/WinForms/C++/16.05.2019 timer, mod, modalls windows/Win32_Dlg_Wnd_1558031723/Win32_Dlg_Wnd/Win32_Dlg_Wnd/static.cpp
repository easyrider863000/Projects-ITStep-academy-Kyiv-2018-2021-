...
{
	hInst = hInstance; // создаём главное окно приложения на основе модального диалога
...
BOOL CALLBACK DlgProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	case WM_INITDIALOG: // получаем дескриптор статика, размещенного на диалоге 
		hStatic1 = GetDlgItem(hWnd, IDC_STATIC1);
		//создаём статик с помощьюCreateWindowEx 
